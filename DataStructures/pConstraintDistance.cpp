...
void pConstraintDistance::solve(vector< Vector3d >& estimation, int nIterations)
{
...
void pConstraintDistance::init(Particle* p1, Particle* p2)
{
    elems.resize(2);
    elems[0] = p1;
    elems[1] = p2;
...
void pConstraintDistance::drawFunc()
{
